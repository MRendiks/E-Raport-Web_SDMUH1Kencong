    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-warning sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                ...
                <div class="sidebar-brand-text mx-3">E-Rapor SD Muhamadiyah</div>
            </a>
                ...
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePage" aria-expanded="true" aria-controls="collapsePage">
                    ...
                    <div id="collapsePage" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="../rapor"> <i class="fa fas fa-book-open fa-1x"></i> Rapor Kelas 7</a>
                            <a class="collapse-item" href="../rapor/index2.php"> <i class="fa fas fa-book-open fa-1x"></i> Rapor Kelas 8</a>
                            <a class="collapse-item" href="../rapor/index3.php"> <i class="fa fas fa-book-open fa-1x"></i> Rapor Kelas 9</a>
                        </div>
                    </div>
            </li>
            <!-- Nav Item - Tables -->
