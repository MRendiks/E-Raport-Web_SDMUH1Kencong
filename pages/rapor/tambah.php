...
$siswa = mysqli_query($koneksi, "SELECT * FROM tbl_siswa") or die(mysqli_error($koneksi));
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg">
                            ...
                            <select name="tahun_ajar" id="tahun_ajar" class="form-control">
                                ...
                                <?php $sql_tahun = mysqli_query($koneksi, "SELECT * FROM tbl_tahun") or die(mysqli_error($koneksi));
