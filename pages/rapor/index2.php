...
$nilai = mysqli_query($koneksi, "SELECT id,nama,nisn,nama_kelas,id_semester,tahun_ajar,nama_mapel,SUM(nilai_umum) AS totalnilai,nilai_huruf,ekstra,nilai_ekstra,sakit,izin,alfa,akhlak,kepribadian,ket,kd_raport  FROM  tbl_nilai WHERE nama_kelas = '8' GROUP BY kd_raport ");
                        ...
                        while ($tampil = mysqli_fetch_assoc($nilai)) :?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="hapus.php?kd_raport=<?= $tampil["kd_raport"]; ?>"  class="badge badge-danger badge-pill" onclick="return confirm('Apakah anda mau menghapus?');">Hapus</a>
                                </td>
