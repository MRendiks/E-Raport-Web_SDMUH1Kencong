                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    ...
                                    if (isset($_POST['login'])) {
                                        ...
                                        if (mysqli_num_rows($query) == 0) {
                                            ...
                                            if ($row['level'] == 1 && $level == 1) {
                                                ...
                                                header("Location: pages/informasi/index.php");
                                            } 
                                            else if ($row['level'] == 3 && $level == 3) {
                                                $_SESSION['username'] = $username;
                                                $_SESSION['level'] = 'siswa';
                                                header("Location: pages/siswa/index.php");
                                            } else {
                                    ...
                                    <form action="" method="POST" class="user">
                                        ...
                                        <div class="form-group">
                                            <input type="submit" name="login"  class="btn btn-primary btn-block" value="Log me in" style="background-color: #CCD5AE;" />
                                        </div>
                                    </form>
