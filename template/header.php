...
<body id="page-top">
    ...
    <!-- Page Wrapper -->
    <div id="wrapper" style="background-color: #CCD5AE;" >
        <!-- Sidebar -->
        <ul style="background-color: #CCD5AE;"  class="navbar-nav bg-gradient-warning sidebar sidebar-dark accordion" id="accordionSidebar">
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="../real1/pages/informasi/index.php">
                <div class="sidebar-brand-icon rotate-n-15">
                    <i class="fas fa-graduation-cap"></i>
                </div>
                <div class="sidebar-brand-text mx-3">E-Rapor <sup>KTSP</sup></div>
            </a>
            <!-- Divider -->
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="../real1/pages/informasi/index.php">
                ...
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePage" aria-expanded="true" aria-controls="collapsePage">
                    ...
                    <div id="collapsePage" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="pages/rapor"> <i class="fa fas fa-book-open fa-1x"></i> Rapor Kelas 7</a>
                            <a class="collapse-item" href="pages/rapor/index2.php"> <i class="fa fas fa-book-open fa-1x"></i> Rapor Kelas 8</a>
                            <a class="collapse-item" href="pages/rapor/index3.php"> <i class="fa fas fa-book-open fa-1x"></i> Rapor Kelas 9</a>
                        </div>
                    </div>
            </li>
            <!-- Nav Item - Tables -->
                    ...
                    <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <button class="btn btn-primary" style="background-color: #CCD5AE;" type="button">
